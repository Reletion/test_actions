...
set_target_properties(libsim_shared PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libsim/liblibsim_shared.so"
  IMPORTED_SONAME_NOCONFIG "liblibsim_shared.so"
  )

list(APPEND _cmake_import_check_targets libsim_shared )
list(APPEND _cmake_import_check_files_for_libsim_shared "${_IMPORT_PREFIX}/lib/libsim/liblibsim_shared.so" )
